...
export class HomePage {
  ...
  private gesture: Gesture;//importar no '@ionic/angular'; pq nao importo sozinho
  ...
  private getureCrtl: GestureController   
  ) {
  ...
  detectSwipe(){
    this.gesture = this.getureCrtl.create({
  ...
  onMove(ev : GestureDetail){ // => tive que importar manualmente o GestureDetail from '@ionic/angular';
    if (!this.swiping){
